...
export default function VerificationModal({ isOpen, onClose }) {
  ...
  const [step, setStep] = useState('benefits'); // 'benefits' | 'form' | 'loading' | 'success'
      ...
      <div style={{
        ...
        {step === 'benefits' && (
          <div>
            {/* Header */}
            <div style={{
              background: 'linear-gradient(135deg, #0F172A 0%, #1E3A8A 60%, #166534 100%)',
              ...
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                margin: '0 auto 1rem',
                boxShadow: '0 0 0 8px rgba(132,204,22,0.2)',
              }}>
              ...
              <h2 style={{ color: 'white', margin: '0 0 0.5rem', fontSize: '1.4rem', fontWeight: 800 }}>
                Get Verified on Dolphin
              </h2>
              <p style={{ color: 'rgba(255,255,255,0.75)', margin: 0, fontSize: '0.9rem' }}>
                Stand out in the startup ecosystem with a verified badge
              </p>
            ...
            <div style={{ padding: '1.5rem' }}>
              <p style={{ fontSize: '0.8rem', color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 600, marginBottom: '0.75rem' }}>
                What you get
              </p>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(132,204,22,0.45)'; }}
                onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(132,204,22,0.35)'; }}
              >
        ...
        {step === 'form' && (
          <div>
            <div style={{ padding: '1.5rem 1.5rem 0', display: 'flex', alignItems: 'center', gap: '0.75rem', borderBottom: '1px solid #F3F4F6', paddingBottom: '1rem' }}>
            ...
            <form onSubmit={handleSubmit} style={{ padding: '1.5rem' }}>
              ...
              <div style={{ marginBottom: '1rem' }}>
                ...
                />
                {errors.fullName && <p style={{ color: '#EF4444', fontSize: '0.78rem', margin: '4px 0 0' }}>{errors.fullName}</p>}
              </div>
              ...
              <div style={{ marginBottom: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <div style={{ padding: '0.625rem 0.75rem', background: '#F9FAFB', border: '1.5px solid #E5E7EB', borderRadius: 8, fontSize: '0.9rem', color: '#374151', flexShrink: 0 }}>
                    🇮🇳 +91
                  </div>
                  <input
                    type="tel"
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                />
                {errors.email && <p style={{ color: '#EF4444', fontSize: '0.78rem', margin: '4px 0 0' }}>{errors.email}</p>}
              </div>
              ...
              <p style={{ textAlign: 'center', fontSize: '0.72rem', color: '#9CA3AF', marginTop: '0.75rem', lineHeight: 1.5 }}>
                🔐 Secured by Cashfree · Your payment info is never stored on our servers
              </p>
            </form>
          </div>
        )}
        ...
        {step === 'loading' && (
          <div style={{ padding: '3rem 2rem', textAlign: 'center' }}>
            ...
            <p style={{ color: '#6B7280', fontSize: '0.875rem', margin: 0 }}>
              You'll be redirected to the secure Cashfree payment page in a moment.
            </p>
